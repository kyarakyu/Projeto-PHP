...
<div class="container" style="margin-top: 40px">
        <form action = "atualizartabela.php" method="post">
...
<form action = "atualizartabela.php" method="post">
        ...
        <fieldset>
            ...
            <label>Nome do produto.</label><br>
                <input class="inputo" type="text" class="form-control" name="nomeProduto"  value="<?php echo $nomeProduto ?>">
                <input type="number" class="form-control" name="id" value="<?php echo $id?>" style="display : none">
            </div>
            <br><br>
            <div class="inputBox">
            <label>Quantidade no estoque.</label><br>
                <input class="inputo" type="number" class="form-control" name="volume" value="<?php echo $volume ?>">
            </div>
            <br><br>
            <div class="inputBox">
            <label>Valor do produto.</label><br>
                <input class="inputo" type="text" class="form-control" name="preco" value="<?php echo $preco ?>">
            </div>
            <br><br>
            <div class="inputBox">
            <label>Descrição do produto.</label><br>
                <input class="inputo" type="text" class="form-control" name="tipoProduto"value="<?php echo $tipoProduto ?>">
                <br><br>
